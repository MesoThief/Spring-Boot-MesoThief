...
enum class CustomOAuth2Provider {
    ...
    protected val DEFAULT_LOGIN_REDIRECT_URL = "{baseUrl}/login/oauth2/code/{registrationID}"

    fun getBuilder(registrationId: String, method: ClientAuthenticationMethod, redirectUri: String): ClientRegistration.Builder {
